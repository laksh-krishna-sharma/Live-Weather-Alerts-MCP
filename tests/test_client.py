...
class TestWeatherClient:
    ...
    async def test_get_weather_alerts_success(self):
        ...
        with patch('client.client.sse_client', return_value=mock_sse_client), \
            ...
            mock_session.call_tool.assert_called_once_with("get_alerts", arguments={"state": "CA"})
    ...
    async def test_get_weather_alerts_different_states(self):
        ...
        with patch('client.client.sse_client', return_value=mock_sse_client), \
            ...
            for state in test_states:
                ...
                mock_session.call_tool.assert_called_with("get_alerts", arguments={"state": state})
    ...
    async def test_get_weather_alerts_default_state(self):
        ...
        with patch('client.client.sse_client', return_value=mock_sse_client), \
            ...
            assert result == mock_result_content
            mock_session.call_tool.assert_called_with("get_alerts", arguments={"state": "CA"})
    ...
    async def test_get_weather_alerts_connection_params(self):
        ...
        with patch('client.client.sse_client', return_value=mock_sse_client) as mock_sse, \
             patch('client.client.ClientSession', return_value=mock_client_session):
