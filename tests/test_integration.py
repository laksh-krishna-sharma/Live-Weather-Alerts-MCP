...
class TestIntegration:
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_forecast_flow(self, mock_forecast_points_response, mock_forecast_response):
    ...
    async def test_api_to_tools_integration(self, mock_nws_response):
        ...
        with patch('weather_mcp.nws_api.httpx.AsyncClient') as mock_client:
            ...
            # Test API call
            api_result = await make_nws_request("https://api.weather.gov/alerts/active/area/TX")
